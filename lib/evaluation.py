...
def evalrank(model_path, token, data_path=None, split='dev', fold5=False, save_path=None, cxc=False):
    """
    ...
    if cxc:
        ...
        if not fold5:
            ...
            file.write("calculate similarity time: "+ str(end - start)+"\n")

            np.savetxt('sim_best.txt', sims, fmt='%.5f') 
            ...
            try:
                ...
                file.write("Average i2t Recall: %.1f\n" % ar)
                print("Image to text: %.1f %.1f %.1f %.1f %.1f" % r)
                file.write("Image to text: %.1f %.1f %.1f %.1f %.1f\n" % r)
                print("Average t2i Recall: %.1f" % ari)
                file.write("Average t2i Recall: %.1f\n" % ari)
                print("Text to image: %.1f %.1f %.1f %.1f %.1f" % ri)
                file.write("Text to image: %.1f %.1f %.1f %.1f %.1f\n" % ri)
            finally:
                file.write("\n\n")
                file.close()
        else:
